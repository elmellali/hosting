                ...
                <div class="col-lg-8">
                    <article class="blog-details">
                        <div class="blog-details__featured-image">
                            <img src="{{ asset('assets/images/blog/blog-post-details.webp') }}" alt="blog post">
                        </div>
                        <div class="blog-details__article-meta mt--40">
                            <a href="#"><span><i class="fa-light fa-user"></i></span>Zayed Khan</a>
                            <span><span><i class="fa-light fa-clock"></i></span>20 Jan 2025, 10:30 pm</span>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6">
                                <div class="post-image">
                                    <img src="{{ asset('assets/images/blog/post-2.webp') }}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-5 align-items-center">
                            <div class="col-md-5">
                                <div class="post-image mb-5 mb-lg-0">
                                    <img src="{{ asset('assets/images/blog/post-3.webp') }}" alt="">
                                </div>
                            </div>
                            <div class="col-md-7">

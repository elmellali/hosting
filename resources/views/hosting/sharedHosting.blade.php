...
@php
    $title = 'Shared Website Hosting';
    $subTitle = 'Fast, secure, and affordable hosting plans for any budget';
    $img = 'src="' . asset('assets/images/banner/breadcrumb-01.webp') . '" width="460" alt=""';
@endphp
...
@section('content')
                ...
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="section-title-area text-center">
                            <h2 class="section-title">Shared Hosting Feature</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    ...
                                    <a href="{{ route('sharedHosting') }}" class="title">Free SSL Certificates</a>
                                    <p class="excerpt">Although SSL certificates are now mandatory, still got your back.</p>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    ...
                                    <a href="{{ route('wordpressHosting') }}" class="title">WordPress and cPanel</a>
                                    <p class="excerpt">Deploy WordPress in seconds with the Softaculous app installer.</p>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    ...
                                    <a href="{{ route('cloudHosting') }}" class="title">Personalized Email Service</a>
                                    <p class="excerpt">Enjoy domain-based email address of your choice to represent.</p>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    ...
                                    <a href="{{ route('resellerHosting') }}" class="title">24/7 Live Support</a>
                                    <p class="excerpt">Need some help? Our team of hosting experts is standing.</p>
    ...
    <div class="rts-hosting-feature-area section__padding body-bg-2">
        <div class="container">
            <div class="section-inner">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="left-side-image">
                            <img src="{{ asset('assets/images/feature/feature-hero-10.webp') }}" width="419" alt="">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="right-side-content">
                            <div class="section-title-area area-2 text-start">
                                <h2 class="section-title">Looking for reliable hosting solutions to Business</h2>
                                <p class="desc">Leverage the power of cloud storage to streamline your data management and
                                    enhance productivity. Our cloud storage solutions offer scalable and flexible plans to
                                    fit your growing needs, ensuring you only pay for what you use.</p>
                            </div>
                            <ul class="feature-list">
                                <li><i class="fa-solid fa-check"></i>Data Backup and Recovery</li>
                                <li><i class="fa-solid fa-check"></i>Integration with Other Services</li>
                                <li><i class="fa-solid fa-check"></i>Performance and Speed</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!-- BRAND AREA -->
    <div class="rts-brand section__padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">

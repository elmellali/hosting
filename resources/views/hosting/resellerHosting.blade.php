...
@php
    ...
    $subTitle = 'The quality you need with all the potential to earn';
    $img = 'src="' . asset('assets/images/banner/breadcrumb-03.webp') . '" width="332" alt=""';
@endphp
                ...
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="section-title-area text-center">
                            <h2 class="section-title">Reseller Hosting Feature</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="rts-hosting-inner">
                        <div class="row g-5">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    <div class="hosting-icon">
                                        <img src="{{ asset('assets/images/hosting/07.svg') }}" alt="">
                                    </div>
                                    <a href="{{ route('sharedHosting') }}" class="title">All the Essentials</a>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    <div class="hosting-icon">
                                        <img src="{{ asset('assets/images/hosting/08.svg') }}" alt="">
                                    </div>
                                    <a href="{{ route('wordpressHosting') }}" class="title">WHM Control</a>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    <div class="hosting-icon">
                                        <img src="{{ asset('assets/images/hosting/09.svg') }}" alt="">
                                    </div>
                                    <a href="{{ route('cloudHosting') }}" class="title">Account Management Tools</a>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    <div class="hosting-icon">
                                        <img src="{{ asset('assets/images/hosting/10.svg') }}" alt="">
                                    </div>

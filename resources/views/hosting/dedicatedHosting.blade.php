...
@section('content')
    ...
    <!-- HOSTING OPTION -->
    <div class="rts-hosting-type section__padding">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="section-title-area text-center">
                            <h2 class="section-title">Dedicated Server Feature</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="rts-hosting-inner">
                        <div class="row g-5">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    <div class="hosting-icon">
                                        <img src="{{ asset('assets/images/hosting/15.svg') }}" alt="">
                                    </div>
                                    <a href="{{ route('sharedHosting') }}" class="title">Free migration</a>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    <div class="hosting-icon">
                                        <img src="{{ asset('assets/images/hosting/16.svg') }}" alt="">
                                    </div>
                                    <a href="{{ route('wordpressHosting') }}" class="title">Management options</a>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    <div class="hosting-icon">
                                        <img src="{{ asset('assets/images/hosting/17.svg') }}" alt="">
                                    </div>
                                    <a href="{{ route('cloudHosting') }}" class="title">Airtight security</a>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="rts-hosting-type__single area-2">
                                    <div class="hosting-icon">
                                        <img src="{{ asset('assets/images/hosting/18.svg') }}" alt="">
                                    </div>
                                    <a href="{{ route('resellerHosting') }}" class="title">Optimized network</a>
    ...
    <div class="rts-pricing-plan table-pricing section__padding body-bg-2">
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section w-640 text-center">
                    <h2 class="rts-section__title">
                        Compare TakeItCloudy Dedicated
                        Hosting Plans
                    </h2>
                </div>
            </div>
                            ...
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        a domain name from EliteHost, we guarantee it will be handed over.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">

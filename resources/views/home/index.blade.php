                                        ...
                                        <div class="row g-5">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="rts-hosting-type__single">
                                                    ...
                                                    <p class="excerpt">The most popular hosting plan available and comes at
                                                        one of the most.
                                                    </p>
                                                    <a href="{{ route('sharedHosting') }}"
                                                        class="primary__btn border__btn">View Details <i
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="rts-hosting-type__single">
                                                    ...
                                                    <a href="{{ route('wordpressHosting') }}" class="title">WordPress
                                                        Hosting</a>
                                                    <p class="excerpt">WordPress Hosting gives you speed and performance
                                                        with a full of
                                                        features.</p>
                                                    <a href="{{ route('wordpressHosting') }}"
                                                        class="primary__btn border__btn">View Details
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="rts-hosting-type__single">
                                                    ...
                                                    <p class="excerpt">Earn additional revenue or support your customers
                                                        with easy-to-use
                                                        reseller.</p>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="rts-hosting-type__single">
                                                    ...
                                                    <a href="{{ route('resellerHosting') }}" class="title">Reseller
                                                        Hosting</a>
                                                    <p class="excerpt">Earn additional revenue or support your customers
                                                        with easy-to-use
                                                        reseller.</p>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="rts-hosting-type__single">
                                                    ...
                                                    <a href="{{ route('dedicatedHosting') }}" class="title">Dedicated
                                                        Hosting</a>
                                                    <p class="excerpt">Hosting that gives you tools you need to run your
                                                        website portions
                                                        business.</p>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="rts-hosting-type__single">
                                                    ...
                                                    <p class="excerpt">Dedicated resources, increased reliability, with two
                                                        levels
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="rts-section text-center">
                                    ...
                                    <p class="rts-section__description w-450 ">Globally incubate next-generation e-services
                                        via state of the
                                        art technology.
                                    </p>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 col-md-5">
                                        <div class="rts-pricing-plan__tab color-primary">
                                            ...
                                            <div class="discount">
                                                <span class="line"><img
                                                        src="{{ asset('assets/images/index-11/plan/offer__vector.svg') }}"
                                    ...
                                    <div class="row g-30 monthly">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="card-plan">
                                                <div class="card-plan__package">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/index-11/plan/basic.svg') }}"
                                                ...
                                                <div class="card-plan__feature">
                                                    <ul class="card-plan__feature--list">
                                                        ...
                                                        <li class="card-plan__feature--list-item">
                                                            <span class="text"><i class="fa-regular fa-xmark"></i> 100 GB
                                                                SSD Storage</span>
                                                            <span class="tolltip" data-bs-toggle="tooltip"
                                                                data-bs-custom-class="pricing-eleven"
                                                                data-bs-placement="bottom"
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="card-plan">
                                                <div class="card-plan__package">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/index-11/plan/premium.svg') }}"
                                                            height="30" width="30" alt="">
                                                    </div>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="card-plan ">
                                                ...
                                                <div class="card-plan__package">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/index-11/plan/cloud.svg') }}"
                                                            height="30" width="30" alt="">
                                                    </div>
                                                ...
                                                <div class="card-plan__feature">
                                                    <ul class="card-plan__feature--list">
                                                        ...
                                                        <li class="card-plan__feature--list-item">
                                                            <span class="text"><i class="fa-regular fa-check"></i> Free
                                                                Email</span>
                                                            <span class="tolltip" data-bs-toggle="tooltip"
                                                                data-bs-custom-class="pricing-eleven"
                                                                data-bs-placement="bottom"
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="rts-section w-790 text-center">
                                    ...
                                    <p class="rts-section__description">Our web hosting, WordPress hosting, and cloud
                                        hosting plans offer
                                        server
                                        locations in: USA, Germany Egypt , India, Chaina, Brazil, Canada, Russia, Australia
                                        and South
                                        Africa.
                                    </p>
                                </div>
                                        ...
                                        <ul class="round-shape">
                                            <li class="one">
                                                <span class="tooltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    aria-label="Canada" data-bs-custom-class="color-elitehost"
                                                    title="Canada"></span>
                                            ...
                                            <li class="nine">
                                                <span class="tolltip" data-bs-toggle="tooltip"
                                                    data-bs-custom-class="color-elitehost" data-bs-placement="bottom"
                                                    data-bs-original-title="South Africa"></span>
                                                <img src="{{ asset('assets/images/flag-09.svg') }}" alt="">
                                            </li>
                                            <li class="ten">
                                                <span class="tolltip" data-bs-toggle="tooltip"
                                                    data-bs-custom-class="color-elitehost" data-bs-placement="bottom"
                                                    data-bs-original-title="Australia"></span>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="left-side-image">
                                            <img src="{{ asset('assets/images/feature/feature-hero-01.webp') }}" width="523"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="right-side-content">
                                            ...
                                            <ul class="feature-list">
                                                <li><i class="fa-solid fa-check"></i>Ensure support is available 24/7,
                                                    including weekends
                                                    and holidays.</li>
                                                <li><i class="fa-solid fa-check"></i>Implement a CDN to deliver content
                                                    quickly to users
                                                    worldwide.</li>
                                                <li><i class="fa-solid fa-check"></i>Offer various support channels such as
                                                    live chat,
                                                    email, phone, and a ticketing system.</li>
                                                <li><i class="fa-solid fa-check"></i>Aim for rapid response times to
                            ...
                            <div class="row align-items-center">
                                    ...
                                    <div class="rts-whychoose__content">
                                        ...
                                        <div class="single">
                                            ...
                                            <div class="single__content">
                                                ...
                                                <p>Ensure your hosting plan includes SSD storage for faster data retrieval.
                                                </p>
                                            </div>
                                        </div>
                                        <!-- single content-->
                                        <div class="single">
                                            ...
                                            <div class="single__content">
                                                ...
                                                <p>Use advanced caching techniques to reduce server load and speed up load
                                                    times.</p>
                                            </div>
                                        </div>
                                        <!-- single content-->
                                        <div class="single">
                                            ...
                                            <div class="single__content">
                                                ...
                                                <p>Implement strong security measures including SSL certificates, DDoS
                                                    protection, and
                                ...
                                <div class="col-lg-6">
                                    <div class="rts-whychoose__image">
                                        <img src="{{ asset('assets/images/feature/feature-hero-02.webp') }}" width="630"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="rts-testimonial__slider testimonial__slider--first">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rts-testimonial__single">
                                                    <div class="quote-icon">
                                                        <img src="{{ asset('assets/images/testimonials/quote.svg') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="content">
                                                        <p>Reliable, fast, and secure. Everything you need from a modern
                                                            hosting provider.
                                                            Their support team is incredibly knowledgeable and always ready
                                                            to help.</p>
                                                    </div>
                                                    <div class="author__meta">
                                                        <div class="author__meta--image">
                                                            <img src="{{ asset('assets/images/author/jamie_knop.png') }}"
                                                                alt="">
                                                        </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rts-testimonial__single">
                                                    ...
                                                    <div class="content">
                                                        <p>The migration was effortless. We moved our entire infrastructure
                                                            over a weekend
                                                            with zero downtime. The speed improvement for our tech stack is
                                                            remarkable.</p>
                                                    </div>
                                                    <div class="author__meta">
                                                        <div class="author__meta--image">
                                                            <img src="{{ asset('assets/images/author/alex_rivera.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="author__meta--details">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rts-testimonial__single">
                                                    ...
                                                    <div class="content">
                                                        <p>My online store has never been faster. My customers noticed the
                                                            difference
                                                            immediately, and our conversion rates have improved
                                                            significantly.</p>
                                                    </div>
                                                    <div class="author__meta">
                                                        <div class="author__meta--image">
                                                            <img src="{{ asset('assets/images/author/sarah_jenkins.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="author__meta--details">
                                        ...
                                        <div class="swiper-button-area">
                                            <div class="swiper-btn swiper-button-prev"><i
                                                    class="fa-regular fa-angle-left"></i></div>
                                            <div class="swiper-btn swiper-button-next"><i
                                        ...
                                        <div class="accordion accordion-flush" id="rts-accordion">
                                            <div class="accordion-item active">
                                                ...
                                                <div id="item__one" class="accordion-collapse collapse collapse show"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        experiences. When you buy
                                                        a domain name from TakeItCloudy, we guarantee it will be handed over
                                                        to you with
                                                        superior standards of service and support. Our primary goal is to
                                                        build a
                                                        customer-focused atmosphere filled with the happiest customers in
                                                        the galaxy. The
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="item__two" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        understand. Say
                                                        it out loud, and make sure it sounds great. Next, search to see if
                                                        it is available.
                                                        If the name you desire is taken with the .com top-level domain,
                                                        there are hundreds
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="item__three" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        .net, and .org.
                                                        Each is globally recognized, and synonymous with trust and
                                                        credibility — all great
                                                        things to attach to your website and online brand. Watch this space
                                                        for new
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="item__four" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        Products might be the same, but every customer is different. That’s
                                                        why we tailor
                                                        our deals to suit as many people as possible. So you get exactly
                                                        what you need, for
                                                        less.
                                                    </div>
                                                </div>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="item__five" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        It’s easy. Once you’ve decided on your website’s domain name and
                                                        started the
                                                        purchase process, you simply choose from specially selected products
                                                        and bundles.
                                                        These give you everything you need to get a website online, like
                                                        your web hosting,
                                                        for example. Once you have what you need, you can use our
                                                        revolutionary Unbox
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="item__six" class="accordion-collapse collapse"
                                                    aria-labelledby="six" data-bs-parent="#rts-accordion">
                                                    <div class="accordion-body">
                                                        Take your pick. All our web hosting plans are built to offer power
                                                        and simplicity,
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="item__seven" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body">
                                                        This promotion applies to new 1st year registrations for new
                                                        customers. One purchase
                                                        per household.
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6">
                                        <div class="feature-wrapper">
                                            ...
                                            <div class="text">
                                                ...
                                                <p class="desc">Our ticketing system is designed to provide you with
                                                    efficient</p>
                                            </div>
                                        </div>
                                    </div>

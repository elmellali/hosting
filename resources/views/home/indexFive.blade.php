                                    ...
                                    <div class="row g-30 monthly">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="card-plan">
                                                <div class="card-plan__package">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/pricing/01.svg') }}" height="60"
                                                            width="60" alt="">
                                                    </div>
                                                ...
                                                <div class="card-plan__feature">
                                                    <ul class="card-plan__feature--list">
                                                        <li>
                                                            <div class="icon">
                                                                <img src="{{ asset('assets/images/pricing/05.svg') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="text">
                                                        ...
                                                        <li>
                                                            <div class="icon">
                                                                <img src="{{ asset('assets/images/pricing/06.svg') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="text">
                                                        ...
                                                        <li>
                                                            <div class="icon">
                                                                <img src="{{ asset('assets/images/pricing/07.svg') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="text">
                                                        ...
                                                        <li>
                                                            <div class="icon">
                                                                <img src="{{ asset('assets/images/pricing/08.svg') }}"
                                                                    alt="">
                                                            </div>
                                                            <div class="text">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="card-plan active">
                                                <div class="card-plan__package">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/pricing/02.svg') }}" height="60"
                                                            width="60" alt="">
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="card-plan">
                                                <div class="card-plan__package">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/pricing/03.svg') }}" height="60"
                                                            width="60" alt="">
                                                    </div>
                                                    <h4 class="package__name">Basic Plan</h4>
                                                </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="card-plan">
                                                <div class="card-plan__package">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/pricing/04.svg') }}" height="60"
                                                            width="60" alt="">
                                                    </div>
                                                    <h4 class="package__name">Basic Plan</h4>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="left-side-image">
                                            <img src="{{ asset('assets/images/feature/feature-hero-08.webp') }}" width="574"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="rts-whychoose__content area-3">
                                            ...
                                            <div class="single">
                                                ...
                                                <div class="single__content">
                                                    ...
                                                    <p>Find the perfect domain name with various extensions (.com, .net,
                                                        .org, etc.).</p>
                                                </div>
                                            </div>
                                            <!-- single content-->
                            ...
                            <div class="service-inner">
                                <ul>
                                    <li class="service-wrapper">
                                        ...
                                        <p class="desc">You don't have to sacrifice quality to get great hosting at a low
                                            cost.</p>
                                    </li>
                                    <li class="service-wrapper">
                                        <div class="icon-area">
                                    ...
                                    <li class="service-wrapper">
                                        ...
                                        <p class="desc">Our easy-to-use drag-and-drop website builder is automatically
                                            included.</p>
                                    </li>
                                    <li class="service-wrapper">
                                        <div class="icon-area">
                                        ...
                                        <p class="desc">Reliability you can count on, so your site will be up and running
                                        </p>
                                    </li>
                                    <li class="service-wrapper">
                                        <div class="icon-area">
                                    ...
                                    <li class="service-wrapper">
                                        ...
                                        <p class="desc">Encrypt data with an automatic SSL plan and access even more
                                            security tools </p>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="row ">
                                <div class="col-12 d-flex justify-content-center">
                                    <div class="rts-section w-460 text-center">
                                        ...
                                        <p class="rts-section__description">We’re honored and humbled by the great feedback
                                            we receive
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rts-testimonial__single2">
                                                    ...
                                                    <div class="content">
                                                        <p>I am using Digital Ocean Plan in Cloud ways and I can confirm it
                                                            is very good.
                                                ...
                                                <div class="rts-testimonial__single2">
                                                    ...
                                                    <div class="content">
                                                        <p>I started my own web hosting business
                                                            their reseller hosting plan, and it's been a great decision. The
                                                            resources are
                                                            ample,
                                                    ...
                                                    <div class="author__meta">
                                                        <div class="author__meta--image">
                                                            <img src="{{ asset('assets/images/author/jahed_khan.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="author__meta--details">
                                                            <a href="#">Jahed Khan</a>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rts-testimonial__single2">
                                                    ...
                                                    <div class="content">
                                                        <p>I've been using their web hosting services for over a year now,
                                                            and I happier.
                                                            The uptime is fantastic, and the customer support team is always
                                                            quick.</p>
                                                    </div>
                                                    <div class="author__meta">
                                                        <div class="author__meta--image">
                                                            <img src="{{ asset('assets/images/author/samira_khan.png') }}"
                                                                alt="">
                                                        </div>
                                                        <div class="author__meta--details">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="rts-testimonial__single2">
                                                    ...
                                                    <div class="content">
                                                        <p>The transition to TakeItCloudy was incredibly smooth. Their
                                                            support team helped
                                                            with the database migration, and we saw an immediate improvement
                                                            in TTFB.
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-10">
                                    <div class="rts-blog__single">
                                        ...
                                        <div class="rts-blog__single--meta">
                                            ...
                                            <a href="{{ route('blogDetails') }}" class="title">Attentive was born in 2015
                                                help

<head>
    ...
    <link rel="canonical" href="https://takeitcloudy.com">
    <meta name="robots" content="index, follow">
    <!-- for open graph social media -->
    <meta property="og:title" content="TakeItCloudy - Web Hosting & WHMCS Template">
    <meta property="og:description" content="Your Ultimate Solution for Web Hosting & WHMCS">
    <meta property="og:image" content="https://www.example.com/image.jpg">
    <meta property="og:url" content="https://takeitcloudy.com/">
    <!-- for twitter sharing -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="TakeItCloudy - Web Hosting & WHMCS Template">
    <meta name="twitter:description" content="Your Ultimate Solution for Web Hosting & WHMCS">
    <meta name="twitter:image" content="{{ asset('assets/images/banner/banner-hero-01.webp') }}">
    <!-- favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/fav.png') }}">

    <title>TakeItCloudy - Web Hosting & WHMCS Template</title>
